          ...
          >
            ...
            <div className="space-y-6 text-muted-foreground">
              <p className="text-lg leading-relaxed">
                Ziea started with a simple idea: women deserve clothing that feels natural, effortless, and just right. We wanted to create pieces that move with your life—no fuss, no overthinking—just style that works for you. Every design, every detail is made with care to make your everyday dressing simple, confident, and true to who you are. We believe every woman deserves to feel seen, comfortable, and beautiful in her own skin. Our clothes are made to celebrate you, quietly supporting your day with love and care.
              </p>
            </div>
            <div className="mt-10">
